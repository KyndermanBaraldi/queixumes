const dimensaoHumana = [
    { disciplina: "Comportamentos, Atitudes e Condutas do Servidor Público", link: "https://forms.gle/KNsTAXbwvcbnzJWB6", caiNaProva: "Não" },
    { disciplina: "Comunicação Interpessoal", link: "https://forms.gle/yPXBAMBYsphcdW8v8", caiNaProva: "Não" },
    { disciplina: "Economia Comportamental", link: "https://forms.gle/65qDWiJA3hicRGgW8", caiNaProva: "Não" },
    { disciplina: "Ética e Correição", link: "https://forms.gle/J8a8k9VcLK3uzNHu9", caiNaProva: "Não" },
    { disciplina: "Liderança de Pessoas e Equipes", link: "https://forms.gle/ZmS8HcpuTVrkZ1Mm9", caiNaProva: "Não" },
  ];
  
  // Dimensão Institucional
  const dimensaoInstitucional = [
    ...
    { disciplina: "Inteligência Fiscal", link: "https://forms.gle/urAZYvTjCCV5HfUw7", caiNaProva: "Não" },
    { disciplina: "Memória Institucional - História da Receita Federal", link: "https://forms.gle/Je4Gw2ayRk9vnpWA9", caiNaProva: "Não" },
    { disciplina: "Política Tributária e Aduaneira", link: "https://forms.gle/gUkhFAsZ681yeGkU9", caiNaProva: "Não" },
  ];
...
export { dimensaoHumana, dimensaoInstitucional, dimensaoTecnica };